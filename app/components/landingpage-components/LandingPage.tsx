...
export default function LandingPage() {
  return (
    <div className="flex flex-col md:flex-row pb-20">
      {/* Left Panel */}
      <div className="md:w-2/3 md:p-8 p-3 md:pl-40 text-center md:text-start">
        <div className="">
          <button className="border-2 border-[#8E8F8E] rounded-3xl px-4 py-2 font-medium ">Hello!</button>
        </div>
        <div className="md:mt-10 mt-4">
          <div className="md:text-3xl text-2xl font-semibold flex flex-col md:space-y-4 space-y-2 font-timesnew">
            <span className="text-[#FF6000]">I&apos;m Sudhakar,</span>
            <span>Frontend Developer</span>
            <span>Based in India.</span>
          </div>
          <div className="md:text-lg text-sm md:mt-10 mt-4 font-sans font-medium text-[#50524f]">
            <span>
        ...
        <div className="mt-10 flex flex-row max-md:justify-between md:space-x-4 relative">
          {/* First Child */}
      ...
      <div className="md:w-1/2 p-8 md:pr-40 flex items-center order-last md:order-last">
        <div className="relative">
          <div className="md:w-72 md:h-72 h-48 w-48 bg-[#FF6000] absolute rounded-full top-2/3 md:top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-2/3">
            <div className="absolute rounded-full top-4 md:top-0 left-40 md:left-60 w-max md:w-full md:h-full z-10 ">
