...
export default function ButtonComponent({ imageSrc, buttonText, isbgWhite }: any) {
  return (
    <div className="space-x-8 flex flex-row relative">
      <div className="flex items-center flex-row  pl-1 ">
        <button className={`${isbgWhite ? 'bg-white' : 'bg-[#3D3F3C]'} absolute left-0 top-0 px-20 rounded-[40px] md:pb-4 py-6 md:py-10 z-10`}></button>
